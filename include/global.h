...
{
    // =========================================================================
    u32 personality[PARTY_SIZE];                                        // 192 b

    // =========================================================================
    u16 moves[PARTY_SIZE * MAX_MON_MOVES];                              // 384 b

    // =========================================================================
    u16 species[PARTY_SIZE];                                            //  96 b

    // =========================================================================
    u16 heldItems[PARTY_SIZE];                                          //  96 b

    // =========================================================================
    u8 levels[PARTY_SIZE];                                              //  48 b
    u8 EVs[PARTY_SIZE];                                                 //  48 b
}; // SIZE: 864 b (108 B)
...
struct SecretBase
{
    ...
    u8 registryStatus:2;
    u8 language;
    u8 numTimesEntered;                                                  // 32 b

    // =========================================================================
    u8 trainerName[PLAYER_NAME_LENGTH];                                  // 56 b

    // =========================================================================
    // Byte 0 of trainerId is used for determining trainer class
    u8 trainerId[TRAINER_ID_LENGTH];                                    //  32 b

    // =========================================================================
    u16 numSecretBasesReceived;                                         //  16 b

    // =========================================================================
    u8 decorations[DECOR_MAX_SECRET_BASE];                              // 128 b

    // =========================================================================
    u8 decorationPositions[DECOR_MAX_SECRET_BASE];                      // 128 b

    // =========================================================================
    struct SecretBaseParty party;                                       // 108 B
}; // SIZE: 1256 b (157 B)
// =================================================================================================
...
struct SaveBlock1
{
    ...
    // =========================================================================
    // Last location healed at; Used for white-out and Teleport
    struct WarpData lastHealLocation;

    // =========================================================================
    // Location Escape Rope and Dig warp to
    struct WarpData escapeWarp;

    // =========================================================================
    u16 savedMusic;
    u8 weather;
    u8 weatherCycleStage;                                          // 32 b (4 B)

    // =========================================================================
    u8 flashLevel;
    u8 playerPartyCount;
    u16 mapLayoutId;                                               // 32 b (4 B)

    // =========================================================================
    u16 mapView[0x100];                                        // 4096 b (512 B)
    ...
    // =========================================================================
    u16 coins;
    // Item assigned to SELECT
    u16 registeredItem;                                            // 32 b (4 B)

    // =========================================================================
    struct ItemSlot pcItems[PC_ITEMS_COUNT];                   // 1600 b (200 B)
    
    // =========================================================================
    struct ItemSlot bagPocket_Items[BAG_ITEMS_COUNT];           // 960 b (120 B)

    // =========================================================================
    struct ItemSlot bagPocket_KeyItems[BAG_KEYITEMS_COUNT];     // 960 b (120 B)

    // =========================================================================
    struct ItemSlot bagPocket_PokeBalls[BAG_POKEBALLS_COUNT];    // 512 b (64 B)

    // =========================================================================
    struct ItemSlot bagPocket_TMHM[BAG_TMHM_COUNT];            // 2048 b (256 B)

    // =========================================================================
    struct ItemSlot bagPocket_Berries[BAG_BERRIES_COUNT];      // 1472 b (184 B)

    // =========================================================================
    struct Pokeblock pokeblocks[POKEBLOCKS_COUNT];             // 2560 b (320 B)

    // =========================================================================
    u8 seen1[NUM_DEX_FLAG_BYTES];                             // 424 b (13.25 B)


    // =========================================================================
    u16 berryBlenderRecords[3];
    u16 trainerRematchStepCounter;                                 // 64 b (8 B)

    // =========================================================================
    u8 trainerRematches[MAX_REMATCH_ENTRIES];                   // 800 b (100 B)

    // =========================================================================
    struct ObjectEvent objectEvents[OBJECT_EVENTS_COUNT];

    // =========================================================================
    struct ObjectEventTemplate objectEventTemplates[OBJECT_EVENT_TEMPLATES_COUNT]; // 64 * 20
    ...
    // =========================================================================
    struct BerryTree berryTrees[BERRY_TREES_COUNT]; // 128 * 8

    // =========================================================================
    struct SecretBase secretBases[SECRET_BASES_COUNT];         // 1256 b (157 B)
