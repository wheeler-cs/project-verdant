...
const u32 gItemIcon_Debugger[] = INCBIN_U32("graphics/items/icons/debugger.4bpp.lz");
const u32 gItemIconPalette_Debugger[] = INCBIN_U32("graphics/items/icon_palettes/debugger.gbapal.lz");
